...
{openshift_cluster_ingress_domain}
      ...
      {openshift_user_admin}

-----------------
This is testing tine. {fruit} One more line
...
URL is: {openshift_console_url}

Openshift user is: {openshift_user}

Openshift password is: {openshift_user_password}

Openshift url: {openshift_console_url}

App domain: {cluster_apps_domain}
......
